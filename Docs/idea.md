...
El objetivo es prevenir errores durante el vibe-coding, sirviendo tanto para proyectos nuevos como para existentes que quieran adoptar estas prácticas.

El prompt inicial detallado está en `@Docs/Prompt.md`
